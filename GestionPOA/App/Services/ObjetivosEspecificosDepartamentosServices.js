angular.module('appGestion')
    .factory('ObjetivosEspecificosDepartamentosServices', ['$http', function ($http) {
        ...
        fact.addAsignacionObjetivosEspecificos = function (tipoDependencia, departamentoID, objetivoEspecificoID) {
            var request = $http({
                method: 'POST',
                url: '../ObjeEspecificosDepartamentoes/Create',
                data: { 'tipoDependenciaID': tipoDependencia.id, 'departamentoID': departamentoID, 'objetivoEspecificoID': objetivoEspecificoID},
                dataType: "json"
            });
            return request;
        }
