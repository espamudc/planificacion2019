angular.module('appGestion')
    .controller('ObjetivosEspecificosDepartamentosController', function (NgTableParams,SubsistemasServices, TiposDependenciasServices, DepartamentosServices, ObjetivosEstrategicosServices, ObjetivosEspecificosServices, ObjetivosEspecificosDepartamentosServices) {
        var vm = this;
        ...
        function cargarTipoDependencia() {
            TiposDependenciasServices.getTipoDependencia().then(function (d) {
                vm.arrOptionTipoDependencias = [];
                angular.forEach(d.data.listtiposdependencias, function (value, key) {
                    vm.arrOptionTipoDependencias.push(value);
                });
            })
        }

        vm.cargarDependencias = function (Obj) {
            DepartamentosServices.getDepartamentoesbyTipo(Obj.Identificador).then(function (d) {
                vm.arrOptionDependencia = [];
                angular.forEach(d.data.listdepartamentos, function (value, key) {
                    vm.arrOptionDependencia.push(value);
                });
            });
        }
        ...
        vm.addAsignacionObjetivoEspecifico = function () {
            var requestResponse = ObjetivosEspecificosDepartamentosServices.addAsignacionObjetivosEspecificos(vm.asignacion.Identificador, vm.asignacion.idDependencia, vm.asignacion.ObjetivosEspecificosId);
