...
namespace GestionPOA.Models
{
    ...
    public partial class PEDIEntities : DbContext
    {
        ...
        public virtual DbSet<TipoDependencia> TipoDependencia { get; set; }
        ...
        public virtual int spLoginIngreso(string usuario, string clave)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spLoginIngreso", usuarioParameter, claveParameter);
        }
    
        public virtual ObjectResult<spTipoDependenciaConsultDHBD_Result> spTipoDependenciaConsultDHBD()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spTipoDependenciaConsultDHBD_Result>("spTipoDependenciaConsultDHBD");
        }
    
        public virtual ObjectResult<spDependenciaByIdentificadorTipoDependenciaConsultDHBD_Result> spDependenciaByIdentificadorTipoDependenciaConsultDHBD(Nullable<int> identificadorTipoDependencia)
        {
            var identificadorTipoDependenciaParameter = identificadorTipoDependencia.HasValue ?
                new ObjectParameter("identificadorTipoDependencia", identificadorTipoDependencia) :
                new ObjectParameter("identificadorTipoDependencia", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spDependenciaByIdentificadorTipoDependenciaConsultDHBD_Result>("spDependenciaByIdentificadorTipoDependenciaConsultDHBD", identificadorTipoDependenciaParameter);
        }
    
        public virtual ObjectResult<spDepartamentoCorreoConsultDHBD_Result> spDepartamentoCorreoConsultDHBD(Nullable<int> identificadorTipoDependencia, Nullable<int> idDependencia)
        {
            var identificadorTipoDependenciaParameter = identificadorTipoDependencia.HasValue ?
                new ObjectParameter("identificadorTipoDependencia", identificadorTipoDependencia) :
                new ObjectParameter("identificadorTipoDependencia", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spDepartamentoCorreoConsultDHBD_Result>("spDepartamentoCorreoConsultDHBD", identificadorTipoDependenciaParameter, idDependenciaParameter);
        }
    
        public virtual ObjectResult<spLoginIngreso2_Result> spLoginIngreso2(string usuario, string clave)
        {
            var usuarioParameter = usuario != null ?
                new ObjectParameter("usuario", usuario) :
                new ObjectParameter("usuario", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spLoginIngreso2_Result>("spLoginIngreso2", usuarioParameter, claveParameter);
        }
    
        public virtual ObjectResult<string> POAorPEDI(string data, Nullable<int> tipoDependenciaID, Nullable<int> deparmentID)
        {
            var dataParameter = data != null ?
                new ObjectParameter("data", data) :
                new ObjectParameter("data", typeof(string));
    
            var tipoDependenciaIDParameter = tipoDependenciaID.HasValue ?
                new ObjectParameter("TipoDependenciaID", tipoDependenciaID) :
                new ObjectParameter("TipoDependenciaID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("POAorPEDI", dataParameter, tipoDependenciaIDParameter, deparmentIDParameter);
        }
    
        public virtual ObjectResult<spMetaAndProgramacionesPEDIDHBD_Result1> spMetaAndProgramacionesPEDIDHBD(Nullable<int> department, string pOAorPEDI)
        {
            var departmentParameter = department.HasValue ?
                new ObjectParameter("department", department) :
                new ObjectParameter("department", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spMetaAndProgramacionesPEDIDHBD_Result1>("spMetaAndProgramacionesPEDIDHBD", departmentParameter, pOAorPEDIParameter);
        }
    
        public virtual ObjectResult<spMetaAndEjecucion_Result1> spMetaAndEjecucion(Nullable<int> tipodependencia, Nullable<int> department, string pOAorPEDI)
        {
            var tipodependenciaParameter = tipodependencia.HasValue ?
                new ObjectParameter("tipodependencia", tipodependencia) :
                new ObjectParameter("tipodependencia", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spMetaAndEjecucion_Result1>("spMetaAndEjecucion", tipodependenciaParameter, departmentParameter, pOAorPEDIParameter);
        }
    
        public virtual ObjectResult<spMetaAndProgramaciones_Result1> spMetaAndProgramaciones(Nullable<int> tipoDependencia, Nullable<int> department, string pOAorPEDI)
        {
            var tipoDependenciaParameter = tipoDependencia.HasValue ?
                new ObjectParameter("tipoDependencia", tipoDependencia) :
                new ObjectParameter("tipoDependencia", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spMetaAndProgramaciones_Result1>("spMetaAndProgramaciones", tipoDependenciaParameter, departmentParameter, pOAorPEDIParameter);
        }
    
        public virtual ObjectResult<spMetaAndEjecucionPEDIGeneral_Result> spMetaAndEjecucionPEDIGeneral()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spMetaAndEjecucionPEDIGeneral_Result>("spMetaAndEjecucionPEDIGeneral");
        }
    
        public virtual ObjectResult<spMetaAndEjecucionPEDI_Result> spMetaAndEjecucionPEDI(Nullable<int> tipodependencia, Nullable<int> department, string pOAorPEDI)
        {
            var tipodependenciaParameter = tipodependencia.HasValue ?
                new ObjectParameter("tipodependencia", tipodependencia) :
                new ObjectParameter("tipodependencia", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spMetaAndEjecucionPEDI_Result>("spMetaAndEjecucionPEDI", tipodependenciaParameter, departmentParameter, pOAorPEDIParameter);
        }
    
        public virtual ObjectResult<Nullable<int>> spMetasInsert(Nullable<int> indicadorId, string descripcion, Nullable<int> tipoCalificacionId, string pEDIorPOA)
        {
            var indicadorIdParameter = indicadorId.HasValue ?
                new ObjectParameter("IndicadorId", indicadorId) :
                new ObjectParameter("IndicadorId", typeof(int));
            ...
            var pEDIorPOAParameter = pEDIorPOA != null ?
                new ObjectParameter("PEDIorPOA", pEDIorPOA) :
                new ObjectParameter("PEDIorPOA", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spMetasInsert", indicadorIdParameter, descripcionParameter, tipoCalificacionIdParameter, pEDIorPOAParameter);
        }
    
        public virtual ObjectResult<Nullable<decimal>> spEvidenciasInsert(Nullable<int> programacionId, string evidencia)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("spEvidenciasInsert", programacionIdParameter, evidenciaParameter);
        }
    }
}
