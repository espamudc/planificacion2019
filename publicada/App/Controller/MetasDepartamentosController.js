angular.module('appGestion')
    .controller('MetasDepartamentosController', function (NgTableParams, $cookies, TiposDependenciasServices,  MetasDepartamentosServices, MetasServices,
        ...
        vm.addAsignacionMeta = function () {
            var requestResponse = MetasDepartamentosServices.addMetasDepartamentos(vm.asignacion.Identificador, vm.asignacion.MetaId, vm.asignacion.idDependencia);
